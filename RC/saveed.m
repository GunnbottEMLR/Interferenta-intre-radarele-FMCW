function main_gui
    ...
    fig = uifigure('Name', 'PROIECT RC', 'Position', [500 200 350 350]);
 global rangeRes
...
Nsweep = 192;                                         % Numărul de eșantioane de timp lent pentru radarul victimă
...
%%
    ...
    secondFig = uifigure('Name', 'Meniu Principal', 'Position', [500 200 550 450]);
